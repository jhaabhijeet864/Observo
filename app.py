"""Simple app entrypoint for Render deployment"""
...
print(f"MAIN APP: Flask app created with name: {__name__}", file=sys.stderr)
print(f"MAIN APP: PORT environment variable: {port}", file=sys.stderr)

# This makes the app work both locally and on Render
if __name__=='__main__':
    logger.info(f"Starting Observo API server on port {port}")
